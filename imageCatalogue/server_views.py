...
def demo_info_milestone_1():
    json_info = {
        ...
        "mikrostoritve": [
            "http://<UPLOAD_IP>:<UPLOAD_PORT>/v1/upload",
            "http://<CATALOGUE_IP>:<CATALOGUE_PORT>/v1/images/",
        ],
        "github": [
            "https://github.com/Squad42/ImageUpload",
            "https://github.com/Squad42/ImageCatalogue",
        ],
        "travis": ["travis image upload", "travis image catalogue"],
        "dockerhub": ["dockerhub image upload", "dockerhub image catalogue"],
    }
